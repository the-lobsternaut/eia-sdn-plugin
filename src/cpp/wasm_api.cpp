/**
 * eia-sdn-plugin WASM API
 *
 * Parses WTI/Brent crude, natural gas, inventories
 */
...
EMSCRIPTEN_BINDINGS(sdn_eia) {
    function("parseJson", &eia::parse_json);
    function("validate", &eia::validate);
}
