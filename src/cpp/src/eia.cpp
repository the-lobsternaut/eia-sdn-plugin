...
// ============================================================================
// parse_json — Parse U.S. Energy Information Administration API JSON response
// ============================================================================
...
DataSet parse_json(const std::string& json_input) {
    ...
    while (obj) {
        ...
        const char* ts_val = find_key(obj, obj_e, "period");
        if (ts_val) {
        ...
        const char* cat_p = find_key(obj, obj_e, "duoarea");
        rec.category = parse_string(cat_p, obj_e);

        const char* desc_p = find_key(obj, obj_e, "seriesDescription");
...
bool validate(const std::string& input) {
    ...
    if (input.find("\"response\"") != std::string::npos) return true;
